...
-(void)runRandomSuggest {
    ...
    [self.randomLabel rollWithArray:self.textArray timeIntervel:0.05 repeatNumb:7];
    [self.randomImage rollWithImageArray:self.imageArray timeIntervel:0.05 repeatNumb:7];
