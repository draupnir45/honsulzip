...
- (void)viewDidLoad {
    ...
    self.firstRowDataSource = [[OnRowCollectionViewDataSource alloc] initWithDataArray:self.mainData];
    self.secondRowDataSource = [[OnRowCollectionViewDataSource alloc] initWithDataArray:self.mainData];
